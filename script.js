...
document.addEventListener('DOMContentLoaded', () => {
    // Render Kartu Kelas saat halaman siap
...
// --- SISANYA TETAP SAMA (dataKelas, openModal, dll) ---

// --- CLASS DATA (URUTAN SUDAH DIRAPIKAN A-I) ---
const dataKelas = [
    { 
        id: 'A', 
    ...
    { 
        id: 'B', 
        names: ["Lia", "Mira"], 
        groupCaptions: ["B1", "B2", "B3", "B4", "B5"] 
    },
    { 
        id: 'C', 
        names: ["Vino", "Wati"], 
        groupCaptions: ["C1", "C2", "C3", "C4", "C5"] 
    },
    { 
        id: 'D', 
        names: [
    ...
    { 
        id: 'E', 
        names: ["Pita", "Rama"], 
        groupCaptions: ["E1", "E2", "E3", "E4", "E5"] 
    },
    { 
        id: 'F', 
        names: ["Bobi", "Cika"], 
        groupCaptions: ["F1", "F2", "F3", "F4", "F5"] 
    },
    { 
        id: 'G', 
        names: ["Lulu", "Mono"], 
        groupCaptions: ["G1", "G2", "G3", "G4", "G5"] 
    },
    { 
        id: 'H', 
        names: ["Vero", "Wira"], 
        groupCaptions: ["H1", "H2", "H3", "H4", "H5"] 
    },
    { 
        id: 'I', 
        names: ["Fahri", "Ghea"], 
        groupCaptions: ["I1", "I2", "I3", "I4", "I5"] 
    }
];
...
function openModal(kelas) {
    ...
    // 1. Render Members (Pakai Nama Asli dari Array)
    ...
    // 2. Render Group Collection (Caption Beda Tiap Foto)
...
// Loading akan hilang otomatis setelah 3 detik, meskipun file lain belum selesai
setTimeout(() => {
